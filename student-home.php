...
if (!$previewPoll && !$activePollId) {
    if ($USER->instructor) {
        echo '<p class="text-right" style="padding:0.5rem;"><a href="build.php" class="h4 pull-right" style="color:var(--primary);">Exit Student View <span class="fas fa-sign-out-alt" aria-hidden="true"></span></a></p>';
    }
